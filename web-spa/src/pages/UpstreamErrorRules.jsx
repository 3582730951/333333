...
function humanSummary(rule) {
  ...
  if (rule.downstream_action === 'hide_safety_buffering') {
    return `对 ${scope} 的 Responses 流隐藏安全检查等待提示；严格 CPA 同样执行该规则，仅移除 safety_buffering 字段，其他事件（包括 response.completed）继续下发。`;
  }
