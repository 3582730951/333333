...
export const manifest = Object.freeze({
  ...
  id: 'grid-wave',
  title: 'Grid Wave',
  composition: Object.freeze({ slot: 'ambient', blend: 'alpha', zIndex: 16, priority: 16, exclusiveGroup: 'background-ambient' }),
  uniforms: Object.freeze({
    uIntensity: Object.freeze({ type: 'float', default: 0.17, min: 0, max: 0.42, step: 0.01, description: 'Grid opacity.' }),
    uSpeed: Object.freeze({ type: 'float', default: 0.34, min: 0, max: 1.4, step: 0.01, description: 'Fixed-clock wave speed.' }),
    uDensity: Object.freeze({ type: 'float', default: 1, min: 0.35, max: 2.2, step: 0.01, description: 'Grid cell density.' }),
    uWave: Object.freeze({ type: 'float', default: 0.38, min: 0, max: 1.2, step: 0.01, description: 'Grid displacement amplitude.' }),
  }),
  quality: Object.freeze({
    ...
    low: Object.freeze({ renderScale: 0.5, detailScale: 0.55, alphaCap: 0.6 }),
  }),
  cost: Object.freeze({
    budgetUnits: Object.freeze({ high: 1.8, medium: 1.05, low: 0.46 }),
    gpuMilliseconds: Object.freeze({ high: 0.56, medium: 0.33, low: 0.18 }),
...
export function applyDomFallback(root) {
  ...
  const attribute = 'data-aurora-grid-wave-fallback';
