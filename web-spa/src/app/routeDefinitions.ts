...
export const adminRoutes = [
  ...
  { path: '/team-lifecycle', role: 'admin', navGroup: 'automation', titleKey: 'nav.team_lifecycle', descriptionKey: 'page.team_lifecycle.desc', lazyLoader: () => import('../pages/TeamLifecycle.tsx'), prefetch: 'idle' },
