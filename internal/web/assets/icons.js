/* icons.js — a small inline-SVG icon set (Feather-style, MIT-derived stroke paths) so
   the UI renders crisp, consistent icons everywhere instead of relying on obscure
   Unicode glyphs that many system fonts lack. icon(name,size) returns an <svg> string
   that inherits the current text color (stroke=currentColor). */
const ICONS = {
