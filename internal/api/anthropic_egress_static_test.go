...
var functionsAllowedToUseThePlainClient = map[string]string{
	...
	"exchangeCodexRefreshToken": "OpenAI OAuth refresh-token exchange via the Codex provider",
	"callAppServer":             "Codex app-server JSON-RPC over the local relay host, not an Anthropic host",
