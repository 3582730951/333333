...
func TestSchedulerAffinityCacheUsesPersistedEpoch(t *testing.T) {
	...
	binding := storage.AffinityBinding{RouteKeyHash: "cache-epoch", RouteKey: "key", Source: "previous_response_id", AccountID: "cache-epoch-a", Provider: "codex", Model: "gpt-5", EgressID: storage.DefaultDirectEgressID, Epoch: 6}
