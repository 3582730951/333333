...
async function pageMetrics(page) {
  return page.evaluate(() => {
    ...
    const auditedContainers = document.querySelectorAll([
      '.pool-topbar-inner', '.pool-page-header', '.pool-page-header__actions',
      '.pool-toolbar', '.pool-metric-rail', '.pool-grid', '.pool-card-body',
      '.pool-mobile-row', '.pool-mobile-row__head', '.pool-mobile-row__actions',
      '.pool-row-actions', '.pool-form-actions', '.pool-lifecycle-readiness__grid',
    ].join(','));
